        ...
        return   (
                                <nav className="header__nav">
                                    ...
                                    <ul className="header__nav_menu">
                                        <li className="header__nav_item header__nav_item-expand"><a href="#">Games</a>
                                        ...
                                        <li className="header__nav_item header__nav_item-expand"><a href="#">Consoles</a>
                                            <ul className="submenu">
                                                <li><a href="./#" target="_blank">Subparagraph #1</a></li>
                                                <li><a href="./#" target="_blank">Subparagraph #2</a></li>
                                                <li><a href="./#" target="_blank">Subparagraph #3</a></li>
                                        ...
                                        <li className="header__nav_item"><a href="#">Community</a></li>
